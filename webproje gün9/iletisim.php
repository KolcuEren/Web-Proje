    ...
    <div id="app" class="container mt-5">
        ...
        <form method="post" action="iletisim_bilgileri.php">
            ...
            <div class="form-group">
                ...
                <input type="radio" id="male" name="gender" value="Erkek" v-model="formData.gender">
                <label for="male">Erkek</label><br>
                <input type="radio" id="female" name="gender" value="Kadın" v-model="formData.gender">
                <label for="female">Kadın</label><br>
                <input type="radio" id="other" name="gender" value="Diğer" v-model="formData.gender">
        ...
        new Vue({
            ...
            methods: {
                ...
                checkJavaScriptValidation() {
                    ...
                    if (name.trim() === '' || email.trim() === '' || !gender || message.trim() === '') {
                ...
                checkVueValidation() {
                    if (this.formData.name.trim() === '' || this.formData.email.trim() === '' || !this.formData.gender || this.formData.message.trim() === '') {
                        alert('Lütfen tüm alanları doldurun!');
                        return;
                    }
