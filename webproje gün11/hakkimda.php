...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-8 profile-text">
            <?php
            // Başarılı giriş yapıldıysa mesajı göster
            if(isset($_SESSION['username'])) {
                echo '<div id="success-message" style="color: green;">Hoşgeldiniz, ' . htmlspecialchars($_SESSION['username']) . '!</div>';
                // Oturumu kapat
                session_unset();
                session_destroy();
            }
        ...
        <div class="spor-hayatim">
            ...
            <p>
                ...
                geliştirmeye</a> merak saldım ve bir kaç ay boyunca bu dal ile uğraştım.
            </p>
            <div class="sporlar">
...
<script>
    // Başarı mesajını göster ve bir süre sonra otomatik olarak kaldır
